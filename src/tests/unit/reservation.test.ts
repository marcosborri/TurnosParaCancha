...
//   field2 = await fieldRepo.addField({name: "CanchaFutbol_B", type: "F5"})
...
//   field1 = await fieldRepo.addField({name: "CanchaFutbol_A", type: "F5"})
...
//     const id = reservation1.getId();
//     const nuevoField = await fieldRepo.addField({name: "CanchaFutbol_C", type: "F11"})

//     await mock.editReservationField({ id, field: nuevoField });
...
//     await mock.editReservationUser({ id, user: nuevoUser });
//     const reservaEditada = await mock.getReservation(id);
...
//     await mock.editReservationPaid({ id, paid: noPagado });
//     const reservaEditada = await mock.getReservation(id);
...
//     await mock.editReservationStart({ id, start: nuevaFecha });
//     const reservaEditada = await mock.getReservation(id);
...
//     await mock.editReservationEnd({ id, end: nuevaFecha });
//     const reservaEditada = await mock.getReservation(id);
